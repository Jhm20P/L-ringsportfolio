...
<html lang="da">
  <head>
    ...
    <title>Photoshop værktøjer</title>
...
<main role="main">
<!-- Banner med overskrift og underoverskrift -->
  <section class="jumbotron text-center">
    <div class="container">
      <h1>Photoshop værktøjer</h1>
      <p class="lead text-muted">Her gennegår jeg de værktøjer jeg har brugt mest i Photoshop</p>
    </div>
  </section>
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <image src="movetool.png" height="auto" width="450">
      </div>
    </div>
    <!-- MOVETOOL SLUT -->
    <hr class="featurette-divider">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">
        <image src="tryllestav.png" height="auto" width="450">
      </div>
    </div>
    <!-- MAGIC WAND TOOL SLUT -->
    <hr class="featurette-divider">
    <!-- LASSO TOOL -->
    <div class="row featurette">
      <div class="col-md-7">
      ...
      <div class="col-md-5">
        <image src="lasso.png" height="auto" width="450">
      </div>
    </div>
    <!-- LASSO TOOL SLUT -->
    <hr class="featurette-divider">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">
        <image src="farvespan.png" height="auto" width="450">
      </div>
    </div>
    <!-- PAINT BUCKET TOOL SLUT -->
    <hr class="featurette-divider">
    <!-- RECTANGLE TOOL -->
    <div class="row featurette">
      <div class="col-md-7">
      ...
      <div class="col-md-5">
        <image src="formgivning.png" height="auto" width="450">
      </div>
    </div>
    <!-- RECTANGLE TOOL SLUT -->
    <hr class="featurette-divider">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">
        <image src="zoomtool.png" height="auto" width="450">
      </div>
    </div>
    <!-- ZOOM TOOL SLUT -->
    <hr class="featurette-divider">
