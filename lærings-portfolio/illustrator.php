...
<html lang="da">
  <head>
    ...
    <title>Illustrator værktøjer</title>
...
<main role="main">
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <image src="select.png" height="auto" width="450"/>
      </div>
    </div>
    <!-- SELECTOR TOOL SLUT -->
    <hr class="featurette-divider">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">
        <image src="tegn.png" height="auto" width="450"/>
      </div>
    </div>
    <!-- TEGNE VÆRKTØJ SLUT -->
    <hr class="featurette-divider">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <image src="farve.png" height="auto" width="450"/>
      </div>
    </div>
    <!-- FARVER SLUT -->
    <hr class="featurette-divider">
